...
if __name__ == "__main__":
    ...
    dataloader_train = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, num_workers=24)
    dataloader_val = DataLoader(val_set, batch_size=args.batch_size, shuffle=False, num_workers=24)
