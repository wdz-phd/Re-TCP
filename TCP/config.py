...
class GlobalConfig:
	...
	# data root
	root_dir_all = "/home/ly/WDZ/TCP/tcp_carla_data"
	...
	# for town in ['town01', 'town03', 'town04', 'town05', 'town06', 'town10']:
	# 	train_data.append(os.path.join(root_dir_all, town+'_addition'))
	# for town in val_towns:
	# 	val_data.append(os.path.join(root_dir_all, town+'_val')) #all data train
	...
	for town in train_towns:
		...
		train_data.append(os.path.join(root_dir_all, town+'_addition'))
	for town in val_towns:
		val_data.append(os.path.join(root_dir_all, town+'_val')) #消融数据集
	...
	rl_ckpt = "/home/ly/WDZ/TCP/roach/log/ckpt_11833344.pth"
