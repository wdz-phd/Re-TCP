...
export TEAM_CONFIG=/home/liyang/WDZ/TCP/log/TCP/best_epoch=29-val_loss=0.785.ckpt
export CHECKPOINT_ENDPOINT=results_TCP_16.json
export SCENARIOS=leaderboard/data/scenarios/all_towns_traffic_scenarios.json
export SAVE_PATH=data/results_TCP_16/
